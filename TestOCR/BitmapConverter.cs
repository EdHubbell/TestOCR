...
/// Note: This code was imported from OpenCvSharp4 because there is some issue 
/// with adding the OpenCvSharp4 NuGet package to the project - It causes an error
/// having to do with OpenCvSharp.Size.Zero when the PaddleOcrResult result = all.Run(src);
/// command is run. 
/// </summary>
